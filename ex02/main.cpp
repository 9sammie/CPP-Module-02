...
/*   Updated: 2026/01/21 17:28:19 by maballet         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    std::cout << GREYBGBOLD << "=== CONSTRUCTORS ===" << STD << std::endl << std::endl;
    Fixed a;
    Fixed b(42);
    Fixed c(42.42f);
    Fixed d(b);
    ...
    std::cout << std::endl << std::endl << GREYBGBOLD << "=== ASSIGNMENT OPERATORS ===" << STD << std::endl << std::endl;
    a = Fixed(10.5f);
    std::cout << GREEN << "a après a = Fixed(10.5f) : " << a << STD << std::endl;

    std::cout << std::endl << std::endl << GREYBGBOLD << "=== ARITHMETICS OPERATORS ===" << STD << std::endl << std::endl;
    Fixed e = b + c;
    Fixed f = c - b;
    Fixed g = b * c;
    Fixed h = c / b;
    ...
    std::cout << std::endl << std::endl << GREYBGBOLD << "=== COMPARISON OPERATORS ===" << STD << std::endl << std::endl;
    ...
    std::cout << std::endl << std::endl << GREYBGBOLD << "=== INCREMENT / DECREMENT ===" << STD << std::endl << std::endl;
    Fixed i;
    ...
    std::cout << std::endl << std::endl << GREYBGBOLD << "=== MIN / MAX ===" << STD << std::endl << std::endl;
    Fixed j(5.5f);
    Fixed k(10.1f);
    std::cout << GREEN << "min(j, k) = " << Fixed::min(j, k) << STD << std::endl;
    std::cout << GREEN << "max(j, k) = " << Fixed::max(j, k) << STD << std::endl;

    std::cout << std::endl << std::endl << GREYBGBOLD << "=== MIN / MAX CONST ===" << STD << std::endl << std::endl;
    const Fixed l(2.2f);
    const Fixed m(3.3f);
    std::cout << GREEN << "min(l, m) = " << Fixed::min(l, m) << STD << std::endl;
    std::cout << GREEN << "max(l, m) = " << Fixed::max(l, m) << STD << std::endl;

    std::cout << std::endl << std::endl << GREYBGBOLD << "=== CONVERSIONS ===" << STD << std::endl << std::endl;
